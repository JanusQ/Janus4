...
uv run python -m ipykernel install --user --name adaptiveqc --display-name "Python (adaptiveqc)"
```
...
| `benchmark/` | MQTBench-derived benchmark QASM files used by larger experiments |
| `docs/TUTORIAL_SETUP.md` | setup notes for the notebook environment |
