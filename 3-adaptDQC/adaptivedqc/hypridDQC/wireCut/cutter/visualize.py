from rustworkx.visualization import graphviz_draw  # pylint: disable=no-name-in-module,import-error
...
def dag_drawer(dag, scale=0.7, filename=None, style="color"):
    ...
    if "DAGDependency" in type_str:
        graph_attrs = {"dpi": str(100 * scale),"splines":False}
        ...
        def node_attr_func(node):
            ...
            if style == "color":
                ...
                raise ValueError("Unrecognized style %s for the dag_drawer." % style)
        ...
        def node_attr_func(node):
            ...
            if style == "color":
                ...
                if isinstance(node, DAGOpNode):
                    ...
                    n['shape'] = 'square'
                    n["fillcolor"] = "lightblue"
                if isinstance(node, DAGBlockNode):
                    n["label"] = node.name
                    n["color"] = "black"
                    n["style"] = "filled"
                    n['shape'] = 'square'
